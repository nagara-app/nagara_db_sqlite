/*
  ...
  - The primary key for the `kanji_querycode` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
CREATE TABLE "new_kanji_querycode" (
    ...
    PRIMARY KEY ("kanji_id", "kwQueryCodeType_id", "value"),
...
INSERT INTO "new_kanji_querycode" ("kanji_id", "kwQueryCodeType_id", "kwSkipMisclass_id", "value") SELECT "kanji_id", "kwQueryCodeType_id", "kwSkipMisclass_id", "value" FROM "kanji_querycode";
