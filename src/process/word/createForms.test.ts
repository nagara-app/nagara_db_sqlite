...
describe('Form creater is creating all possible forms', () => {
  ...
  test('With kanji forms and kana forms with no kanji, where extra kana forms are needed', () => {
    ...
    const result = createFormCombinations(jmReles, jmKeles, true);
    const expected = [
      {kana: 'あそこ'},
      {kana: 'あすこ'},
      {kana: 'かしこ'},
