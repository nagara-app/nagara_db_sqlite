...
export type JMdictSensPos =
    'unc' | 'n' | 'exp' | 'adj-na' | 'adj-no' |
    'adj-i' | 'v5u' | 'vt' | 'pn' | 'adv' |
    'adv-to' | 'vs' | 'adj-pn' | '∫' | 'v1' |
    'vi' | 'v5s' | 'v5k' | 'v5r' | 'v5aru' |
    'aux-v' | 'adj-f' | 'conj' | 'prt' | 'v5m' |
    'n-suf' | 'v5g' | 'v5r-i' | 'suf' | 'adj-t' |
    'vs-i' | 'adj-ix' | 'aux' | 'cop' | 'pref' |
    'vk' | 'aux-adj' | 'n-pref' | 'ctr' | 'num' |
    'vs-s' | 'adj-shiku' | 'v5t' | 'v5b' | 'v5k-s' |
    'vz' | 'v2m-s' | 'vs-c' | 'v1-s' | 'v4r' |
    'v5n' | 'vn' | 'adj-ku' | 'v-unspec' | 'v4m' |
    'v2r-k' | 'v2r-s' | 'v5u-s' | 'vr' | 'v4s' |
    'adj-nari' | 'v2t-k' | 'v4h' | 'v4g' | 'v2h-s' |
    'v4k' | 'v2g-s' | 'v2a-s' | 'v4b' | 'v2y-s' |
    'v4t' | 'v2d-s' | 'v2y-k' | 'v2k-k' | 'v2k-s' |
    'v2g-k' | 'v2b-k' | 'v2s-s' | 'v2z-s' | 'v2t-s' |
    'v2n-s' | 'v2w-s' | 'v2h-k';

export type JMdictSensField =
    'food' | 'baseb' | 'fish' | 'med' | 'hanaf' |
    'physics' | 'MA' | 'sumo' | 'shogi' | 'sports' |
    'bot' | 'Christn' | 'comp' | 'golf' | 'chem' |
    'music' | 'ling' | 'math' | 'astron' | 'photo' |
    'logic' | 'finc' | 'electr' | 'gramm' | 'aviat' |
    'grmyth' | 'phil' | 'cards' | 'print' | 'econ' |
    'geol' | 'vidg' | 'bus' | 'tradem' | 'pharm' |
    'biol' | 'elec' | 'cloth' | 'mahj' | 'mil' |
    'genet' | 'archeol' | 'anat' | 'archit' | 'law' |
    'rail' | 'zool' | 'stat' | 'Buddh' | 'Shinto' |
    'art' | 'telec' | 'met' | 'geom' | 'physiol' |
    'go' | 'engr' | 'geogr' | 'psych' | 'biochem' |
    'horse' | 'ent' | 'kabuki' | 'pathol' | 'cryst' |
    'gardn' | 'psy' | 'agric' | 'paleo' | 'ornith' |
    'audvid' | 'mech' | 'ecol' | 'dent' | 'politics';

export type JMdictSensMisc =
    'abbr' | 'id' | 'obs' | 'uk' |
    'col' | 'euph' | 'on-mim' | 'arch' |
    'hon' | 'fem' | 'chn' | 'sl' |
    'fam' | 'male' | 'vulg' | 'derog' |
    'pol' | 'joc' | 'hum' | 'rare' |
    'form' | 'dated' | 'proverb' | 'net-sl' |
    'hist' | 'sens' | 'quote' | 'person' |
    'place' | 'yoji' | 'poet' | 'leg' |
    'work' | 'm-sl';
